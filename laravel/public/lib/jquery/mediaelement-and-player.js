		...
		buildoverlays: function(player, controls, layers, media) {
			...
			loading =
				$('<div class="mejs-overlay mejs-layer">'+
				  ...
				  '<div class="mejs-overlay-loading"><div id="circleG"><div id="circleG_1" class="circleG"></div><div id="circleG_2" class="circleG"></div><div id="circleG_3" class="circleG"></div></div></div>'+
				'</div>')
		...
		buildvolume: function(player, controls, layers, media) {
			...
			var t = this,
				...
				'<div class="mejs-horizontal-volume-slider">'+ // outer background
					...
					'<div class="mejs-horizontal-volume-current"><span class="slider-ctrl"></span></div>'+ // current volume
